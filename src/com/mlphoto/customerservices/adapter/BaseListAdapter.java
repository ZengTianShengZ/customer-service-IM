...
public abstract class BaseListAdapter<ChatMessage> extends BaseAdapter {
	...
	public BaseListAdapter(Context context, List<ChatMessage> list) {
		super();
